...
import styles from './homepage-heading.module.css';
...
const HomePageHeading = props => (
  <Grid
    ...
    sm={12}
    spacing={24}
    className={styles.homepageHeadingContainer}
  >
    <Grid
      container
      sm={12}
      spacing={24}
      className={styles.headingShadowContainer}
    >
      ...
      <Grid item sm={12} className={styles.buttonContainer}>
        <ButtonDiv className={styles.buttonDiv}>
          ...
          >
            Make a Request if you want to loser
          </Button>
        </ButtonDiv>
      </Grid>
    </Grid>
